...
const Radiology = ({
  ...
  const addServiceToState = (item) => {
    addRadiology({ newRadiology: item, r_id: index });
  };
      ...
      <View>
        ...
        >
          <Pressable
            ...
            onPress={() => deleteRadiology({ radiologyindex: index })}
          >
...
const mapDispatchToProps = (dispatch) => {
  return {
    deleteRadiology: (item) => dispatch(deleteRadiology(item)),
    addRadiology: (item) => dispatch(addRadiology(item)),
